...
- Decision ledger
- Decision explainability graph (explainable "why" artifacts)
- More scanner support
- Expanded intelligence sources
- CVE aggregated scoring (instead of highest-risk CVE)
- Integrations

## v1.3.0-1.5.0+

- SQLite historical tracking features
- Plus more
